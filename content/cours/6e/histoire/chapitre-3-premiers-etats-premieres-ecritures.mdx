...
resume: "Vers 3500-3000 av. J.-C., dans le Croissant fertile, naissent les premières grandes civilisations. L'Égypte, organisée autour du Nil et dirigée par le pharaon, et la Mésopotamie, divisée en cités-États, inventent l'écriture et créent les premiers États organisés."
vocabulaire:
  - terme: "Crue"
    definition: "Débordement annuel du fleuve (le Nil) qui dépose du limon fertile sur les terres."
  - terme: "Limon"
    definition: "Terre fertile déposée par le Nil lors de sa crue annuelle."
  - terme: "Pharaon"
    definition: "Roi-dieu de l'Égypte, considéré comme le fils de Rê et l'incarnation d'Horus. Propriétaire de tout le pays."
  - terme: "Scribe"
    definition: "Personne qui sait lire et écrire, chargée de l'administration du royaume."
  - terme: "Corvée"
    definition: "Travail obligatoire et gratuit imposé aux paysans par le pharaon."
  - terme: "Polythéisme"
    definition: "Croyance en plusieurs dieux (poly = plusieurs, theos = dieu)."
  - terme: "Momification"
    definition: "Technique de conservation des corps des défunts pour permettre la survie de l'âme dans l'au-delà."
  - terme: "Hiéroglyphes"
    definition: "Écriture sacrée égyptienne composée de dessins représentant des sons, des mots ou des idées."
  - terme: "Papyrus"
    definition: "Support d'écriture fabriqué à partir de la plante du même nom, utilisé en Égypte."
  - terme: "Calame"
    definition: "Roseau taillé servant à écrire sur le papyrus ou les tablettes d'argile."
  - terme: "Cité-État"
    definition: "Ville indépendante avec son propre territoire, son roi, son armée et ses dieux protecteurs."
  - terme: "Cunéiforme"
    definition: "Première écriture de l'histoire, inventée par les Sumériens, composée de signes en forme de coins tracés sur des tablettes d'argile."
  - terme: "Ziggourat"
    definition: "Pyramide à étages au centre des cités mésopotamiennes, lieu de culte des dieux."
  - terme: "Code de lois"
    definition: "Recueil de règles écrites organisant la vie en société."
  - terme: "Vases canopes"
    definition: "Vases contenant les organes prélevés lors de la momification."
  - terme: "Natron"
    definition: "Sel utilisé pour dessécher les corps lors de la momification."
methodes_liees:
...
| Saison | Période | Activités |
|--------|---------|-----------|
| **Akhet** (Inondation) | Juillet → Octobre | Crue, dépôt du limon |
| **Péret** (Germination) | Novembre → Février | Semailles, labour |
| **Chémou** (Récolte) | Mars → Juin | Moisson, stockage |

### B. Une société hiérarchisée

La société égyptienne est organisée comme une **pyramide** avec une stricte hiérarchie :

| Niveau | Catégorie | Rôle |
|--------|-----------|------|
| Sommet | **Le Pharaon** | Roi-dieu, « fils de Rê », incarnation d'Horus. Propriétaire de tout. |
| Élite | **Prêtres et Scribes** | Servent les dieux / Savent lire et écrire, gèrent l'administration. |
| Intermédiaire | **Artisans spécialisés** | Sculpteurs, orfèvres, embaumeurs, tisserands... |
| Base | **Paysans** | Majorité de la population. Cultivent et doivent la corvée (travail obligatoire). |
...
| Dieu | Apparence | Fonction |
|------|-----------|----------|
| **Rê (Râ)** | Disque solaire | Dieu du Soleil, créateur, père des pharaons |
| **Osiris** | Momie couronnée | Dieu des morts, juge les âmes dans l'au-delà |
| **Anubis** | Tête de chacal | Protecteur de l'embaumement et des morts |
| **Horus** | Tête de faucon | Protecteur des pharaons (incarnation vivante) |
...
| Critère | Égypte | Mésopotamie |
|---------|--------|-------------|
| Fleuve(s) | Le Nil | Tigre et Euphrate |
| Organisation | Un royaume unifié | Cités-États rivales |
| Écriture | Hiéroglyphes | Cunéiforme |
| Support | Papyrus, pierre | Tablettes d'argile |
