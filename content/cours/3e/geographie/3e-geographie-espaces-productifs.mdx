---
titre: "Les espaces productifs français et leurs évolutions"
niveau: "3e"
matiere: "geographie"
chapitre: 3
theme: "Dynamiques territoriales de la France contemporaine"
resume: "Les espaces productifs français (industriels, agricoles, tertiaires) sont profondément transformés par la mondialisation. La tertiarisation domine (78 % des emplois). L'exemple de Toulouse illustre un espace industriel inséré dans la mondialisation via Airbus et Aerospace Valley. Les espaces productifs sont inégalement dynamiques : métropoles et façades maritimes captent la croissance, tandis que les anciennes régions industrielles et les espaces ruraux isolés sont en difficulté."
vocabulaire:
  - terme: "Espace productif"
    definition: "Lieu où s'exercent des activités économiques (industrielles, agricoles ou de services) qui produisent des richesses."
  - terme: "Pôle de compétitivité"
    definition: "Regroupement d'entreprises, de centres de recherche et d'organismes de formation autour d'un domaine précis sur un territoire."
  - terme: "Donneur d'ordres"
    definition: "Grande entreprise qui confie la fabrication de certains composants ou services à d'autres entreprises (les sous-traitants)."
  - terme: "Sous-traitant"
    definition: "Entreprise qui réalise une partie de la production pour le compte d'une autre entreprise (le donneur d'ordres)."
  - terme: "Facteurs de localisation"
    definition: "Ensemble des éléments qui expliquent pourquoi une activité économique s'installe dans un lieu précis (main-d'œuvre, transport, recherche, héritage historique…)."
  - terme: "Délocalisation"
    definition: "Transfert d'activités économiques (usines, services) d'un pays vers un autre, généralement pour réduire les coûts de production."
  - terme: "Tertiarisation"
    definition: "Processus par lequel le secteur des services devient le secteur dominant de l'économie (en nombre d'emplois et en création de richesses)."
  - terme: "Reconversion"
    definition: "Transformation d'un espace économique en crise par le développement de nouvelles activités en remplacement de celles qui ont disparu."
  - terme: "Technopôle"
    definition: "Parc d'activités spécialisé dans les hautes technologies, souvent situé à proximité d'universités et de centres de recherche."
  - terme: "Agriculture productiviste"
    definition: "Agriculture intensive cherchant à maximiser les rendements par l'utilisation massive de techniques modernes (mécanisation, engrais, irrigation)."
  - terme: "Métropolisation"
    definition: "Concentration des populations et des richesses dans les grandes métropoles."
  - terme: "Mondialisation"
    definition: "Intensification des échanges économiques à l'échelle de la planète."
methodes_liees:
...
Un **espace productif** est un lieu où s'exercent des activités économiques qui produisent des richesses. Ces espaces sont au cœur du fonctionnement économique du pays et sont profondément transformés par la **mondialisation**, c'est-à-dire l'intensification des échanges à l'échelle de la planète.
...
## I. Étude de cas : Toulouse, un espace productif industriel
...
- **Des centres de recherche** : ONERA (Office National d'Études et de Recherches Aérospatiales), CNES (Centre National d'Études Spatiales), laboratoires universitaires.
- **Des établissements de formation** : lycée professionnel Airbus, ENAC (École Nationale de l'Aviation Civile), ISAE-SUPAERO, université Paul-Sabatier (Toulouse-III).
...
| **Facteurs de localisation** | Éléments expliquant l'implantation d'une activité en un lieu précis. |
