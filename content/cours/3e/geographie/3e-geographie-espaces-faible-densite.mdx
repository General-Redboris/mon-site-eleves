---
titre: "Les espaces de faible densité et leurs atouts"
niveau: "3e"
matiere: "geographie"
chapitre: 2
theme: "Dynamiques territoriales de la France contemporaine"
resume: "Les espaces de faible densité occupent 42 % du territoire français mais ne rassemblent que 6,5 % de la population. Souvent marginalisés (déprise, enclavement, désertification), ils disposent cependant d'atouts (agriculture, tourisme vert, patrimoine) et bénéficient de politiques d'aménagement (ZRR, PNR, désenclavement numérique)."
vocabulaire:
  - terme: "Densité de population"
    definition: "Rapport entre la population et la superficie du territoire qu'elle occupe, mesuré en habitants par km²."
  - terme: "Espace rural"
    definition: "Ensemble de l'espace n'appartenant pas à la ville, présentant une faible densité de population."
  - terme: "Déprise (rurale)"
    definition: "Recul important de l'activité économique et de la population dans un espace rural."
  - terme: "Désertification (rurale)"
    definition: "Processus de vidage démographique et de disparition des services dans un espace rural (densité inférieure à 10 hab./km²)."
  - terme: "Enclavement"
    definition: "Isolement d'un territoire difficile d'accès, mal relié au reste du territoire."
  - terme: "Contraintes naturelles"
    definition: "Éléments naturels (relief, climat, sols) qui font obstacle à l'installation des hommes et des activités."
  - terme: "Diagonale du vide"
    definition: "Espace de faibles densités qui traverse la France du nord-est (Ardennes) au sud-ouest (Pyrénées)."
  - terme: "Exode rural"
    definition: "Départ massif et durable des habitants des campagnes vers les villes."
  - terme: "Néoruraux"
    definition: "Citadins qui font le choix de s'installer à la campagne, à la recherche d'un nouveau cadre de vie."
  - terme: "Tourisme vert"
    definition: "Forme de tourisme centrée sur la découverte de la nature, des paysages et du patrimoine rural."
  - terme: "Fracture numérique"
    definition: "Inégalité d'accès et d'équipement numérique entre les territoires."
  - terme: "ZRR (Zone de Revitalisation Rurale)"
    definition: "Zone bénéficiant d'avantages fiscaux pour aider les territoires ruraux en difficulté à attirer des entreprises et de nouveaux habitants."
  - terme: "PNR (Parc Naturel Régional)"
    definition: "Territoire rural reconnu pour la qualité de son patrimoine naturel et culturel, où une politique d'aménagement concilie protection de l'environnement et développement économique."
  - terme: "Touristification"
    definition: "Processus par lequel un territoire développe volontairement une offre touristique pour dynamiser son économie locale."
  - terme: "Hyper-ruralité"
    definition: "Situation extrême des espaces ruraux les plus isolés, cumul de difficultés : très faible densité, vieillissement, absence de services, enclavement."
  - terme: "Agriculture extensive"
    definition: "Agriculture qui utilise de grandes surfaces mais avec peu de moyens techniques et de faibles rendements."
  - terme: "Agriculture intensive"
    definition: "Agriculture qui utilise beaucoup de moyens techniques (engrais, machines) pour obtenir des rendements élevés sur des surfaces limitées."
methodes_liees:
...
## II. Étude de cas : le Cantal, un espace de faible densité
...
| Indicateur | Cantal | France métropolitaine |
|-----------|--------|----------------------|
| Densité | 25 hab./km² | 119 hab./km² |
| Habitants de moins de 15 ans | 14 % | 23 % |
| Habitants de plus de 60 ans | 36 % | 23 % |
| Part des résidences secondaires | 20,4 % | 9,4 % |
| Taux de natalité | 7,8 ‰ | 11,2 ‰ |
| Taux de mortalité | 14 ‰ | 9,1 ‰ |
...
Malgré ses difficultés, le Cantal dispose d'atouts et met en œuvre des stratégies pour se redynamiser.
...
- **Le Puy Mary**, au cœur du plus grand strato-volcan d'Europe, est un site naturel d'exception qui attire de nombreux randonneurs.
...
- **Le viaduc de Garabit**, ouvrage de Gustave Eiffel (1884), est devenu un pôle d'attraction patrimoniale majeur, éclairé la nuit comme une œuvre d'art.
...
À l'échelle nationale, si les espaces de faible densité rencontrent des difficultés importantes, certains disposent d'atouts qui peuvent les aider à les surmonter.
...
L'aménagement du territoire vise à lutter contre la déprise et à réduire l'isolement des espaces ruraux. Les principaux acteurs sont l'État et les collectivités locales. Plusieurs outils ont été mis en place :
...
| Type d'espace | Caractéristiques | Exemples |
|--------------|-----------------|----------|
| **1. Espaces à dominante agricole** | L'agriculture reste l'activité dominante. Espaces productifs intégrés aux marchés nationaux et mondiaux. | Beauce, Brie, Champagne (céréales), espaces viticoles |
| **2. Espaces redynamisés** | Espaces ruraux en voie de diversification, notamment grâce au tourisme ou à l'arrivée de néoruraux. Reprise démographique possible. | Alpes du Nord (sports d'hiver), arrière-pays méditerranéen, communes périurbaines éloignées |
...
| Notion | Définition |
|--------|-----------|
| **Agriculture extensive** | Agriculture sur de grandes surfaces, avec peu de moyens techniques et de faibles rendements. |
| **Agriculture intensive** | Agriculture à hauts rendements grâce à une forte utilisation de moyens techniques. |
| **Contrainte naturelle** | Élément naturel qui fait obstacle à l'installation des hommes et des activités. |
| **Densité de population** | Rapport entre la population et la superficie (hab./km²). |
...
| **Diagonale du vide** | Espace de faibles densités traversant la France des Ardennes aux Pyrénées. |
| **Enclavement** | Isolement d'un territoire difficile d'accès. |
| **Espace rural** | Espace n'appartenant pas à la ville, à faible densité de population. |
| **Exode rural** | Départ massif et durable des habitants des campagnes vers les villes. |
| **Fracture numérique** | Inégalité d'accès au numérique entre les territoires. |
| **Hyper-ruralité** | Situation extrême des espaces ruraux les plus isolés et en difficulté. |
| **Néoruraux** | Citadins qui font le choix de s'installer à la campagne. |
| **PNR** | Parc Naturel Régional : concilie protection de l'environnement et développement. |
| **Tourisme vert** | Tourisme centré sur la nature, les paysages et le patrimoine rural. |
| **Touristification** | Développement volontaire d'une offre touristique pour dynamiser un territoire. |
| **ZRR** | Zone de Revitalisation Rurale : avantages fiscaux pour les territoires en difficulté. |
