...
vocabulaire:
  - terme: "Déflation"
    definition: "Politique économique qui vise à faire baisser les prix en réduisant les salaires et les dépenses de l'État. Dans les années 1930, cette politique a aggravé la crise."
  - terme: "Ligues"
    definition: "Organisations politiques d'extrême droite des années 1930, hostiles à la République parlementaire, favorables à un pouvoir autoritaire."
  - terme: "Antiparlementarisme"
    definition: "Hostilité envers le Parlement et le système parlementaire, considérés comme inefficaces et corrompus."
  - terme: "Accords de Matignon"
    definition: "Accords signés le 7-8 juin 1936 entre patronat et syndicats, sous l'arbitrage du gouvernement Blum. Ils prévoient des hausses de salaires, la liberté syndicale et les conventions collectives."
  - terme: "Congés payés"
    definition: "Périodes de vacances pendant lesquelles le salarié continue de percevoir son salaire."
  - terme: "Convention collective"
    definition: "Accord écrit négocié entre syndicats et patronat d'un secteur d'activité, fixant les conditions de travail et de salaire."
  - terme: "Antisémitisme"
    definition: "Haine, hostilité et discrimination envers les personnes juives. L'antisémitisme peut se manifester par des insultes, des violences, des discriminations ou des persécutions."
  - terme: "Non-intervention"
    definition: "Politique consistant à ne pas s'engager militairement dans un conflit étranger."
  - terme: "Calomnie"
    definition: "Accusation mensongère destinée à nuire à la réputation d'une personne."
---
...
| Date | Événement |
|------|-----------|
| **Octobre 1929** | Krach boursier de Wall Street (début de la crise mondiale) |
| **1931** | La crise économique touche la France |
| **Janvier 1934** | Affaire Stavisky (scandale politico-financier) |
| **6 février 1934** | Émeute des ligues à Paris (15 morts) |
| **9 et 12 février 1934** | Contre-manifestations de la gauche pour défendre la République |
| **14 juillet 1935** | Naissance officielle du Front populaire |
| **Février 1936** | Agression de Léon Blum par l'extrême droite |
| **Mai 1936** | Victoire électorale du Front populaire ; Blum président du Conseil |
| **Mai-juin 1936** | Grèves avec occupation d'usines (2 millions de grévistes) |
| **7-8 juin 1936** | Accords de Matignon |
| **Été 1936** | Lois sur les congés payés et la semaine de 40 heures |
| **Novembre 1936** | Suicide de Roger Salengro |
| **Juin 1937** | Démission de Léon Blum |
| **Avril 1938** | Fin du Front populaire (départ du Parti radical) |
