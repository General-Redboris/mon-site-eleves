...
vocabulaire:
  - terme: "Guerre totale"
    definition: "Conflit qui mobilise toutes les ressources d'un pays : soldats, civils, économie, propagande."
  - terme: "Guerre d'anéantissement"
    definition: "Guerre visant la destruction totale de l'adversaire, y compris les populations civiles."
  - terme: "Économie de guerre"
    definition: "Réorganisation de l'économie pour produire du matériel militaire."
  - terme: "Lend-Lease (Prêt-bail)"
    definition: "Aide matérielle américaine aux Alliés (51 milliards de dollars)."
  - terme: "Rationnement"
    definition: "Limitation des quantités de produits disponibles par personne."
  - terme: "Ersatz"
    definition: "Produit de substitution remplaçant un produit devenu rare."
  - terme: "Bombardement stratégique"
    definition: "Bombardement massif des villes pour détruire l'industrie et démoraliser la population."
  - terme: "Crime de guerre"
    definition: "Violation grave des lois de la guerre : meurtre de civils, torture, destruction injustifiée."
  - terme: "Génocide"
    definition: "Extermination volontaire, planifiée et systématique d'un groupe humain en raison de son origine."
  - terme: "Shoah"
    definition: "Mot hébreu signifiant « catastrophe ». Désigne le génocide des Juifs d'Europe (6 millions de morts)."
  - terme: "Porajmos"
    definition: "Génocide des Tziganes (250 000 à 500 000 victimes)."
  - terme: "Solution finale"
    definition: "Nom donné par les nazis à leur projet d'extermination des Juifs d'Europe."
  - terme: "Ghetto"
    definition: "Quartier fermé où les nazis enfermaient les Juifs dans des conditions inhumaines."
  - terme: "Einsatzgruppen"
    definition: "Unités mobiles de tuerie chargées de massacrer les Juifs en URSS (Shoah par balles)."
  - terme: "Camp d'extermination"
    definition: "Camp conçu pour assassiner les déportés dès leur arrivée (≠ camp de concentration)."
  - terme: "Chambre à gaz"
    definition: "Lieu où les nazis assassinaient les déportés avec du Zyklon B."
  - terme: "Zyklon B"
    definition: "Gaz toxique (insecticide) utilisé dans les chambres à gaz."
  - terme: "Crime contre l'humanité"
    definition: "Crime visant à exterminer une population civile pour des raisons ethniques, religieuses ou politiques."
  - terme: "Procès de Nuremberg"
    definition: "Procès des dirigeants nazis (1945-1946). Premier tribunal international, création de la notion de « crime contre l'humanité »."
---
...
| Date | Territoire annexé | Contexte |
|------|-------------------|----------|
| Mars 1936 | Rhénanie | Remilitarisation en violation du traité de Versailles |
| Mars 1938 | Autriche (Anschluss) | Annexion de l'Autriche au Reich |
| Octobre 1938 | Sudètes (Tchécoslovaquie) | Accords de Munich — politique d'apaisement |
| Mars 1939 | Bohême-Moravie | Fin de la Tchécoslovaquie |
...
| Les puissances de l'Axe | Les Alliés |
|--------------------------|------------|
...
| Pays | Personnes mobilisées (millions) | Part de la population totale |
|------|-------------------------------|------------------------------|
| URSS | 34,5 | 17,4 % (25 % hors territoires occupés) |
| Allemagne | 17,2 | 18 % |
| États-Unis | 16,1 | 10 % |
| Chine | 14 | — |
| Japon | 9,1 | — |
...
| Pays | Femmes dans l'armée | Rôle particulier |
|------|---------------------|------------------|
| Armée rouge (URSS) | 850 000 | Participation aux combats (2 000 snipeuses) |
| Armée britannique | 450 000 | Auxiliary Territorial Service |
| Armée américaine | 400 000 | Principalement rôles de soutien |
| Wehrmacht (Allemagne) | 500 000 | Auxiliaires |
...
| Pays | Part du PIB consacrée à la guerre | Année |
|------|-----------------------------------|-------|
| Japon | 70 % | dès 1937 |
| Allemagne | 70 % | 1943 |
| URSS | 60 % | 1943 |
...
| Innovation | Pays | Caractéristiques |
|------------|------|------------------|
| Messerschmitt Me 262 | Allemagne | Premier avion de chasse à réaction de l'histoire |
| V1 | Allemagne | Premier missile de croisière (bombe volante) |
| V2 | Allemagne | Premier missile balistique (près de 3 000 tirés) |
| Bombe atomique | États-Unis | Projet Manhattan — première explosion nucléaire (Trinity, 16 juillet 1945) |
...
|--|--------------------------|------------------------------|
| **Valeurs défendues** | Égalité des hommes, liberté, tolérance | Inégalité des « races », domination, soumission |
| **Vision de l'humanité** | Tous les hommes sont égaux aux yeux de Dieu | Hiérarchie raciale (Aryens « supérieurs ») |
| **Objectif de la guerre** | Défense des droits, vaincre la tyrannie | Conquête de l'« espace vital », anéantissement |
...
| **Population** | 250 000 habitants | 240 000 habitants |
...
| Lieu | Date | Responsables | Victimes | Bilan |
|------|------|-------------|----------|-------|
| Nankin (Chine) | Déc. 1937 – Fév. 1938 | Armée japonaise | Civils chinois | Dizaines de milliers de morts, 20 000-80 000 viols |
| Oradour-sur-Glane (France) | 10 juin 1944 | SS Das Reich | Habitants du village | 643 morts |
| Villages soviétiques | 1941-1944 | Armée allemande | Civils, partisans | 5 000 villages rasés |
...
| Fonction | Nom | Rôle dans le génocide |
|----------|-----|----------------------|
| Chef de la SS et de la police | Heinrich Himmler | Décide et supervise l'ensemble du génocide |
| Chef du RSHA | Reinhard Heydrich | Organise la conférence de Wannsee, coordonne l'extermination |
| Responsable logistique | Adolf Eichmann | Organise les transports ferroviaires vers les camps |
...
| Camp | Localisation | Période d'activité | Victimes estimées |
|------|-------------|-------------------|-------------------|
| Auschwitz-Birkenau | Pologne (Oświęcim) | 1942-1945 | 1,1 million (dont 1 million de Juifs) |
| Treblinka | Pologne | 1942-1943 | 800 000 – 900 000 |
| Belzec | Pologne | 1942 | 430 000 – 500 000 |
| Sobibor | Pologne | 1942-1943 | 170 000 – 250 000 |
| Chelmno | Pologne | 1941-1945 | 150 000 – 300 000 |
| Majdanek | Pologne (Lublin) | 1942-1944 | 60 000 – 80 000 |
...
| Population | Victimes estimées | Pourcentage exterminé |
|-----------|-------------------|----------------------|
| Juifs d'Europe | 6 millions (sur 9 millions) | Environ 67 % |
| Tziganes (Porajmos) | 250 000 à 500 000 | 25-50 % |
...
| Chef d'accusation | Définition |
|-------------------|------------|
| Crimes contre la Paix | Planification et déclenchement d'une guerre d'agression |
| Crimes de guerre | Violations des lois et coutumes de la guerre (massacres de civils, torture de prisonniers) |
| Crimes contre l'Humanité | Extermination, réduction en esclavage, déportation pour des motifs politiques, raciaux ou religieux |
...
| Catégorie | Chiffres |
|-----------|----------|
| Bilan total | 60 à 80 millions de morts |
| Dont civils | 40 à 50 millions (majorité des victimes) |
| URSS | 25 à 27 millions de morts (pays le plus touché) |
| Chine | 15 à 20 millions de morts |
| Pologne | 6 millions de morts (17 % de la population) |
...
| Date | Événement |
|------|-----------|
| 1937-1938 | Massacre de Nankin (Chine) |
| 1er septembre 1939 | Invasion de la Pologne — Début de la Seconde Guerre mondiale |
| Mai 1940 | Offensive allemande à l'Ouest — Défaite française |
| 22 juin 1941 | Invasion de l'URSS (opération Barbarossa) — Début de la Shoah par balles |
| 29-30 sept. 1941 | Massacre de Babi Yar (34 000 Juifs assassinés en 2 jours) |
| 7 décembre 1941 | Attaque de Pearl Harbor — Entrée en guerre des États-Unis |
| 20 janvier 1942 | Conférence de Wannsee — Organisation de la « Solution finale » |
| Avril-mai 1943 | Insurrection du ghetto de Varsovie |
...
| Nov. 1945 – Oct. 1946 | Procès de Nuremberg |
...
- **Mémorial de la Shoah (Paris) :** [www.memorialdelashoah.org](https://www.memorialdelashoah.org) — ressources pédagogiques, témoignages vidéo
- **Yad Vashem (Israël) :** [www.yadvashem.org](https://www.yadvashem.org) — base de données des victimes, histoire de la Shoah
- **United States Holocaust Memorial Museum :** [www.ushmm.org](https://www.ushmm.org) — ressources en français disponibles
- **Centre d'histoire de la Résistance et de la Déportation (Lyon) :** [www.chrd.lyon.fr](https://www.chrd.lyon.fr)
- **INA — Jalons pour l'histoire du temps présent :** [fresques.ina.fr/jalons](https://fresques.ina.fr/jalons) — archives vidéo commentées
