...
vocabulaire:
  - terme: "Seigneurie"
    definition: "Territoire sur lequel un seigneur exerce son autorité. Elle comprend le château, le village, les terres cultivées, les forêts et les cours d'eau."
  - terme: "Droit de ban"
    definition: "Pouvoir de commander, d'interdire et de punir que le seigneur exerce sur tous les habitants de sa seigneurie."
  - terme: "Suzerain"
    definition: "Seigneur qui accorde un fief et sa protection à un vassal."
  - terme: "Vassal"
    definition: "Homme qui reçoit un fief d'un suzerain et lui jure fidélité en échange."
  - terme: "Fief"
    definition: "Terre accordée par un suzerain à son vassal en échange de sa fidélité et de ses services."
  - terme: "Hommage"
    definition: "Cérémonie par laquelle un homme devient le vassal d'un seigneur. Elle comprend trois étapes : l'hommage (mains jointes), la féauté (serment) et l'investiture (remise du fief)."
  - terme: "Adoubement"
    definition: "Cérémonie au cours de laquelle un écuyer devient chevalier. Elle comprend le bain, la veillée d'armes, la remise des armes et la colée."
  - terme: "Vilain"
    definition: "Paysan libre, qui peut quitter la seigneurie. Le mot vient de « villa » (domaine) et n'a rien d'insultant à l'époque médiévale."
  - terme: "Serf"
    definition: "Paysan non-libre, attaché à la terre de la seigneurie. Il ne peut pas partir sans autorisation."
  - terme: "Corvée"
    definition: "Travail gratuit que les paysans doivent effectuer sur les terres du seigneur."
  - terme: "Dîme"
    definition: "Impôt en nature (1/10e de la récolte) versé à l'Église pour l'entretien du clergé et des pauvres."
  - terme: "Clergé séculier"
    definition: "Prêtres, curés et évêques qui vivent au contact des fidèles dans le monde."
  - terme: "Clergé régulier"
    definition: "Moines et moniales qui vivent retirés du monde selon une règle religieuse."
  - terme: "Scriptorium"
    definition: "Salle où les moines copient les manuscrits. Ce travail patient a permis de conserver les textes de l'Antiquité."
  - terme: "Cloître"
    definition: "Galerie couverte entourant un jardin, au cœur du monastère. Lieu de méditation et de lecture."
---
