...
matiere: "histoire"
chapitre: 1
resume: "Entre le VIe et le XIIIe siècle, deux empires chrétiens héritent de Rome : l'Empire byzantin autour de Constantinople et l'Empire carolingien en Europe occidentale. Malgré un héritage commun, ils évoluent différemment et finissent par se séparer lors du schisme de 1054."
vocabulaire:
  - terme: "Empire byzantin"
    definition: "Nom donné par les historiens à l'Empire romain d'Orient, qui survit à la chute de Rome et dure jusqu'en 1453. Sa capitale est Constantinople (l'ancienne Byzance)."
  - terme: "Empire carolingien"
    definition: "Empire fondé par Charlemagne en 800, qui regroupe une grande partie de l'Europe occidentale sous l'autorité d'un empereur chrétien."
  - terme: "Chrétienté"
    definition: "Ensemble des territoires et des peuples qui partagent la religion chrétienne."
  - terme: "Bosphore"
    definition: "Détroit qui sépare l'Europe de l'Asie, sur lequel est bâtie Constantinople."
  - terme: "Asie Mineure"
    definition: "Ancienne dénomination de la péninsule correspondant à l'actuelle Turquie."
  - terme: "Basilique"
    definition: "Grand édifice religieux chrétien."
  - terme: "Coupole"
    definition: "Voûte de forme hémisphérique (en forme de demi-sphère) surmontant un édifice."
  - terme: "Code Justinien"
    definition: "Recueil des lois romaines rédigé sur ordre de l'empereur Justinien, qui servira de base au droit européen."
  - terme: "Basileus"
    definition: "Titre de l'empereur byzantin (mot grec signifiant « roi »)."
  - terme: "Césaropapisme"
    definition: "Système dans lequel l'empereur (César) exerce un pouvoir sur l'Église, réunissant autorité politique et autorité religieuse."
  - terme: "Icône"
    definition: "Image sacrée peinte sur bois, représentant le Christ, la Vierge ou les saints, vénérée par les chrétiens orthodoxes."
  - terme: "Mosaïque"
    definition: "Composition décorative réalisée à partir de petits fragments de pierre, de verre ou de céramique colorés."
  - terme: "Croix grecque"
    definition: "Plan d'église en forme de croix dont les quatre branches sont de longueur égale."
  - terme: "Patriarche"
    definition: "Chef de l'Église chrétienne d'Orient, équivalent du pape pour les orthodoxes."
  - terme: "Besant"
    definition: "Monnaie d'or de l'Empire byzantin, utilisée dans tout le bassin méditerranéen."
  - terme: "Barbares"
    definition: "Terme utilisé par les Romains pour désigner les peuples extérieurs à l'Empire romain. Les historiens préfèrent aujourd'hui parler de « peuples germaniques »."
  - terme: "Mérovingiens"
    definition: "Première dynastie de rois francs, fondée selon la tradition par Mérovée (Ve siècle)."
  - terme: "Carolingiens"
    definition: "Dynastie de rois puis d'empereurs francs fondée par Pépin le Bref en 751. Charlemagne en est le représentant le plus célèbre."
  - terme: "Comté"
    definition: "Territoire administratif de l'empire carolingien, dirigé par un comte nommé par l'empereur."
  - terme: "Comte"
    definition: "Représentant de l'empereur dans un comté ; il rend la justice, lève les impôts et commande l'armée."
  - terme: "Marche"
    definition: "Comté frontalier de l'empire, zone tampon protégeant le territoire."
  - terme: "Missi dominici"
    definition: "« Envoyés du maître » : inspecteurs envoyés en binôme (un laïc et un religieux) pour contrôler les comtes."
  - terme: "Capitulaire"
    definition: "Texte législatif édité par l'empereur carolingien, organisé en chapitres (capitula)."
  - terme: "Monastère"
    definition: "Lieu où vivent des moines ou des moniales selon une règle religieuse (la règle de saint Benoît pour les Bénédictins)."
  - terme: "Scriptorium"
    definition: "Atelier d'écriture dans un monastère, où les moines copient et enluminent des manuscrits."
  - terme: "Minuscule caroline"
    definition: "Nouvelle écriture mise au point sous Charlemagne, plus claire et lisible que les écritures précédentes. Elle est à l'origine de notre écriture actuelle."
  - terme: "Renaissance carolingienne"
    definition: "Renouveau culturel et intellectuel impulsé par Charlemagne, fondé sur la copie des textes antiques, l'amélioration de l'écriture et le développement des écoles."
  - terme: "Traité de Verdun"
    definition: "Accord de 843 par lequel les trois petits-fils de Charlemagne se partagent l'empire carolingien en trois royaumes."
  - terme: "Féodalité"
    definition: "Système politique et social fondé sur les liens personnels entre seigneurs et vassaux, qui se développe après la dislocation de l'empire carolingien."
  - terme: "Schisme"
    definition: "Rupture, séparation au sein d'une Église. Le schisme de 1054 sépare la chrétienté en deux : catholiques (Occident) et orthodoxes (Orient)."
  - terme: "Excommunication"
    definition: "Sanction religieuse qui exclut une personne de la communauté des fidèles."
  - terme: "Filioque"
    definition: "Mot latin signifiant « et du Fils ». Désigne le désaccord théologique entre chrétiens d'Orient et d'Occident sur la procession de l'Esprit Saint."
  - terme: "Catholique"
    definition: "Du grec katholikos, « universel ». Désigne l'Église chrétienne d'Occident, placée sous l'autorité du pape."
  - terme: "Orthodoxe"
    definition: "Du grec orthodoxos, « qui a la bonne croyance ». Désigne l'Église chrétienne d'Orient."
methodes_liees:
...
1. L'Empire byzantin est l'héritier direct de l'Empire romain d'Orient. Sa capitale, Constantinople, est la plus grande ville du monde chrétien.
2. Justinien (527-565) porte l'Empire byzantin à son apogée : reconquêtes, Code Justinien, Sainte-Sophie.
3. L'Empire byzantin est un empire chrétien orthodoxe où l'empereur (basileus) domine l'Église (césaropapisme).
4. Charlemagne (768-814) bâtit un vaste empire carolingien en Europe occidentale, couronné empereur en 800.
5. L'empire carolingien est organisé en comtés, contrôlés par des missi dominici. L'Église y joue un rôle central.
6. La « renaissance carolingienne » est un renouveau culturel marqué par le développement des écoles, des scriptoria et de la minuscule caroline.
7. En 843, le traité de Verdun partage l'empire carolingien en trois royaumes.
8. Le schisme de 1054 sépare définitivement les chrétientés d'Orient (orthodoxe) et d'Occident (catholique).
9. Malgré les tensions, les deux empires entretiennent des échanges diplomatiques, commerciaux et culturels.
